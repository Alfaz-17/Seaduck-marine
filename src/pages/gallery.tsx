...
const Gallery: NextPageWithLayout<GalleryProps> = ({ images }) => {
  ...
  return (
    <>
      <SEO 
        title="Photo Gallery"
        description="Explore Sea Duck Marine Service's state-of-the-art office and workshop facilities where we test, recondition, and certify marine electronics."
