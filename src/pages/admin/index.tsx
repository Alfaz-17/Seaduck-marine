    ...
    <div className="space-y-12">
      ...
      <div className="grid lg:grid-cols-2 gap-8 mt-12">
        <div className="bg-primary/80 p-10 text-white relative h-64 flex flex-col justify-center border border-primary-light/20">
            ...
            <p className="text-slate-300 text-sm italic mb-8 font-sans">Maintain the high standard of Sea Duck Marine Service by reviewing, cataloging, and updating the spare parts inventory.</p>
