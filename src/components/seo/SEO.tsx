...
const siteMetadata = {
  title: 'Sea Duck Marine Service',
  titleTemplate: '%s | Sea Duck Marine Service',
  ...
  siteUrl: 'https://seaduckmarine.com', // Replace with actual domain when live
  defaultImage: '/logo.png',
  twitterHandle: '@seaduckmarine',
